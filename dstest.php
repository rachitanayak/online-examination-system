	...
	<body>
		...
		<div class="main-content">
			<div class="title" style="text-align:left;">
				...
				<h1 style="color:#2d4066;text-align:center;">DATA STRUCTURE TEST</h1>
				<div id="timer">10:00</div>
			    
				<form action="checked.php?test_id=3&usn=<?php echo $usn;?>" method="post">
				
					<?php
						
						$q="select * from question where test_id=3";
